    ...
    return (
        <>
            <SEO
                ...
                canonical={`http://localhost:3000/property/${property.id}`}
                keywords="studio flats business bay furnished, balcony apartments business bay, gym facilities residential"
            ...
            <div className="lg:p-20 p-4 mt-10 -mb-16">
                <div className="container justify-between items-center">
                    ...
                    <div className="flex space-x-2 text-[#003153]">
                        ...
                        <Link to="/pricing" className="hover:underline text-[#003153] text-xl">
                            Property
                        </Link>
                        <GoDotFill size={10} className="mt-2.5 text-[#003153]" />
